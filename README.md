...
2. Dans **Assets**, télécharger **NimbyTco-0.1.0-windows-x64.zip** (pas « Source code »).
...
- Cliquer sur un marqueur de train : sélectionner son Path, affiché en doré.
...
SDK 0.4.0, binaire reconnu par SHA-256 :
...
Télécharger et extraire le paquet de développement SDK 0.4.0 depuis les
[releases du SDK](https://github.com/NimbyRails-France/sdk/releases).
Depuis ce dépôt :

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File ./build.ps1 -SdkRoot C:/SDK/NimbyRailsSDK-0.4.0
./build/NimbyTco.exe
```
...
pendant huit secondes et échoue si moins de deux captures arrivent ; le nombre
